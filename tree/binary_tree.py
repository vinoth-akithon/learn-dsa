...
class BinarySearchTree:
    ...
    def __is_binary_search_tree(self, root, min_value, max_value):
        ...
        if root.value < min_value or root.value > max_value:
            return False
        return self.__is_binary_search_tree(root.left_child, min_value, root.value - 1) and \
                self.__is_binary_search_tree(root.right_child, root.value + 1, max_value)
    ...
    def is_binary_search_tree(self):
        return self.__is_binary_search_tree(self.root, float("-inf"), float("inf"))
